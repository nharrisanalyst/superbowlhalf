...
document.querySelector('#app').innerHTML = `
  <div>
    ...
    <div id="subTitle">
     The half time score is very predictive of who will win the game. Before Super Bowl 51 with Tom Bardy's New England Patriots not team had ever overcome a 7 point half time deficit.
    </div>
    </div>
    <div id="chart"></div>
  </div>
